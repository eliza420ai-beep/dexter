...
The meta-point: we’re deploying AI research infrastructure to build a better AI infrastructure investor. The thesis is eating itself — in the best possible way. Full loop: **SOUL.md sets direction → Dexter executes in real markets → AutoResearch-MLX sharpens the brain → repeat.**
